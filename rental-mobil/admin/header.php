...
<html lang="en">
  ...
  <body>
  <div class="jumbotron pt-4 pb-4" style="background-color: #333;">
        <div class="row">
            <div class="col-sm-8">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <li class="nav-item <?php if($title_web == 'Dashboard'){ echo 'active';}?>">
                    <a class="nav-link" href="http://localhost/rental-mobil/admin/">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item <?php if($title_web == 'User'){ echo 'active';}?>">
                    <a class="nav-link" href="http://localhost/rental-mobil/admin/user">User / Pelanggan</a>
                </li>
                ...
                <?php if($title_web == 'Edit Mobil'){ echo 'active';}?>">
                    <a class="nav-link" href="http://localhost/rental-mobil/admin/mobil/mobil.php">Daftar Mobil</a>
                </li>
                <li class="nav-item <?php if($title_web == 'Daftar Booking'){ echo 'active';}?>
                <?php if($title_web == 'Konfirmasi'){ echo 'active';}?>">
                    <a class="nav-link" href="http://localhost/rental-mobil/admin/booking/booking.php">Daftar Booking</a>
                </li>
                <li class="nav-item <?php if($title_web == 'Peminjaman'){ echo 'active';}?>">
                    <a class="nav-link" href="http://localhost/rental-mobil/admin/peminjaman/peminjaman.php">Peminjaman / Pengembalian</a>
                </li>
                <li class="nav-item <?php if($title_web == 'Peminjaman'){ echo 'active';}?>">
                    <a class="nav-link" onclick="return confirm('Apakah anda ingin logout ?');" href="http://localhost/rental-mobil/admin/logout.php">Logout</a>
                </li>
            </ul>
    </nav>