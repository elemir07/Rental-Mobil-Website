...
<br>
<div class="container">
<a class="back-btn btn-warning" href="booking.php" role="button"><i class="fa-solid fa-angle-left" style="margin-right: 7px;"></i>Kembali</a>
<div class="row">
    <div class="col-sm-4">
        ...
        <div class="card-bayar">
            <div class="card-header">
                <h3 class="card-title" style="margin-bottom: 10px;"><?php echo $isi['merk'];?></h3>
            </div>
            ...
            <div class="card-footer">
                <a href="../peminjaman/peminjaman.php?id=<?php echo $hasil['kode_booking'];?>" 
    ...
    <div class="col-sm-8">
         <div class="card-bayar">
            <div class="card-header">
            <h3 style="margin-bottom: 10px;"> Detail Booking</h3>
            </div>
           <div class="card-body">
